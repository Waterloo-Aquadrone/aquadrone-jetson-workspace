...
Config.instname = "University of Waterloo"
Config.profilename = "University of Waterloo eduroam"
Config.url = " \
    ""https://uwaterloo.ca/information-systems-technology/services/service-desk-ec2-ist"
Config.email = "helpdesk@uwaterloo.ca"
Config.title = "eduroam CAT"
Config.server_match = "eduroam.uwaterloo.ca"
...
Config.user_realm = "uwaterloo.ca"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:eduroam.uwaterloo.ca']
